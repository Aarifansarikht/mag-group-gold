      ...
      <main className="flex-grow">
        ...
        <section className="py-24 relative">
             ...
             <div className="container mx-auto px-6 max-w-6xl relative z-10">
                 ...
                 {/* Quote / Highlight */}
                 <div className="bg-gradient-to-r from-ink to-stone-900 rounded-[2rem] p-12 text-center relative overflow-hidden mb-24 shadow-2xl">
        ...
        <Link href={`/projects/${nextProject.id}`} className="group block relative h-[60vh] overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                <span className="text-yellow-400 font-mono text-sm font-bold uppercase tracking-widest mb-4">Next Project</span>
