      ...
      <div className="h-[40%] p-6 md:p-8 flex flex-col justify-between relative bg-white group-hover:bg-amber-50/20 transition-colors">
         ...
         <div>
            <div className="flex items-center gap-3 mb-2 md:mb-3">
               ...
               <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-stone-400">Product Line</span>
            </div>
            <h3 className="text-xl md:text-2xl font-display font-bold text-stone-900 leading-none mb-2 md:mb-3 group-hover:text-cobalt transition-colors">{title}</h3>
         ...
         <div className="flex items-center justify-between border-t border-stone-100 pt-4 md:pt-6 mt-2">
            <span className="text-[10px] md:text-xs font-bold uppercase text-stone-900 group-hover:text-cobalt transition-colors">View Specifications</span>
            <ArrowRight size={14} className="text-stone-300 group-hover:text-cobalt transform group-hover:translate-x-2 transition-all" />
         </div>
      </div>
  </motion.div>
);
      ...
      <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end z-10">
         ...
         <div className="transform translate-y-4 md:translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
            ...
            <div className="mb-4 md:mb-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100 flex flex-wrap gap-2">
                {specs.map((s, i) => (
                    <span key={i} className="px-2 py-1 border border-cobalt/50 bg-cobalt/10 text-yellow-200 text-[9px] md:text-[10px] font-mono font-bold uppercase tracking-wider rounded backdrop-blur-md">
                        {s}
                    </span>
                ))}
            </div>

            <h3 className="text-2xl md:text-4xl font-display font-bold text-white mb-2 md:mb-3 leading-none group-hover:text-yellow-400 transition-colors">{title}</h3>
            ...
            <Link href={link} className="inline-flex items-center justify-between w-full p-3 md:p-4 rounded-xl bg-white/5 border border-white/10 group-hover:bg-cobalt group-hover:border-cobalt transition-all group-hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] backdrop-blur-sm">
...
const ProjectThumb = ({ title, location, image }: { title: string, location: string, image: string }) => (
    <div className="group relative aspect-[4/5] rounded-[1.5rem] md:rounded-3xl overflow-hidden cursor-pointer shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
        ...
        <div className="absolute bottom-0 left-0 p-6 md:p-8 w-full">
            <div className="h-1 w-8 bg-gradient-to-r from-cobalt to-yellow-300 mb-3 md:mb-4 group-hover:w-16 transition-all duration-300" />
            <h4 className="text-white font-display font-bold text-xl md:text-2xl leading-tight mb-1 md:mb-2">{title}</h4>
            <p className="text-stone-300 text-[10px] md:text-xs font-mono uppercase tracking-wider flex items-center gap-2">
           ...
           <div className="container mx-auto max-w-7xl relative z-10">
              <SectionReveal className="flex flex-col lg:flex-row items-end gap-10 lg:gap-16 mb-16 md:mb-24">
                  <div className="lg:w-3/5">
                      <div className="flex items-center gap-4 mb-4 md:mb-6">
                        <div className="h-[2px] w-8 md:w-12 bg-gradient-to-r from-cobalt to-yellow-400"></div>
                      ...
                      <h2 className="font-display text-4xl sm:text-5xl md:text-8xl font-bold text-ink leading-[0.9] tracking-tight">
                        The Invisible <br/>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cobalt via-yellow-600 to-stone-700">Framework.</span>
                      </h2>
                  </div>
                  <div className="lg:w-2/5 pb-0 md:pb-4">
                      <p className="text-base md:text-xl text-stone-600 leading-relaxed font-medium mb-8 md:mb-10 border-l-2 border-stone-200 pl-4 md:pl-6">
                      ...
                      <div className="flex gap-4 pl-4 md:pl-6">
                         <div className="flex -space-x-3 md:-space-x-4">
                            {[1,2,3].map(i => (
                                <div key={i} className="w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-white bg-stone-200 flex items-center justify-center overflow-hidden shadow-sm">
                         ...
                         <div className="flex flex-col justify-center">
                            ...
                            <span className="text-[10px] md:text-xs text-stone-500">Across 2 Countries</span>
                         </div>
                      </div>
                  </div>
              </SectionReveal>
              ...
              <SectionReveal className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                  {[
                    ...
                    <div key={i} className="group bg-white p-5 md:p-8 rounded-[1.5rem] md:rounded-[2rem] border border-stone-100 hover:border-cobalt/30 transition-all hover:-translate-y-2 hover:shadow-xl hover:shadow-cobalt/5 relative overflow-hidden">
                       ...
                       <div className="relative z-10">
                           ...
                           <p className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-stone-500">{stat.label}</p>
                       </div>
                    </div>
                  ))}
              </SectionReveal>
           ...
           <div className="container mx-auto px-4 md:px-6 relative z-10">
              <SectionReveal className="mb-12 md:mb-16 text-center max-w-3xl mx-auto">
                   <div className="inline-flex items-center gap-2 bg-white px-3 py-1.5 md:px-4 md:py-2 rounded-full shadow-md shadow-stone-200/50 mb-6 md:mb-8 border border-stone-100">
                      ...
                      <span className="text-stone-500 font-mono text-[10px] md:text-xs font-bold uppercase tracking-widest">Division 01</span>
                   </div>
                   <h2 className="font-display text-4xl md:text-6xl font-bold text-stone-900 mb-4 md:mb-6">Drainage Products</h2>
              ...
              <div className="mt-12 md:mt-16 text-center">
                 <Link href="/products">
                    <Button variant="outline" className="rounded-full bg-white border-stone-200 text-stone-900 hover:border-cobalt hover:bg-cobalt hover:text-white px-8 md:px-10 h-12 md:h-14 text-xs md:text-sm shadow-xl shadow-stone-200 transition-all hover:scale-105">
                        View Full Catalog
                    </Button>
                 </Link>
              </div>
              ...
              <SectionReveal className="flex flex-col md:flex-row justify-between items-end gap-6 md:gap-8 mb-12 md:mb-20 pb-8 border-b border-white/10">
                 <div className="max-w-2xl">
                   <div className="flex items-center gap-3 mb-4 md:mb-6">
                      ...
                      <span className="text-stone-400 font-mono text-[10px] md:text-xs uppercase tracking-widest border border-stone-700 px-3 py-1 rounded-full bg-stone-800/50">ISO 3834-2 Certified</span>
                   </div>
                 ...
                 <div className="bg-white/5 border border-white/10 p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] backdrop-blur-md hover:bg-white/10 transition-colors w-full md:w-auto">
                    <div className="flex items-baseline gap-2">
                        <span className="text-4xl md:text-5xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-cobalt to-yellow-200">35k</span>
                        <span className="text-xs md:text-sm font-bold text-white uppercase">Tons / Year</span>
                    </div>
                    <p className="text-[10px] md:text-xs text-stone-400 mt-2 uppercase tracking-wider">Total Production Capacity</p>
                 </div>
              </SectionReveal>
           ...
           <div className="container mx-auto px-4 md:px-6 relative z-10">
              ...
              <SectionReveal className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center mb-16 md:mb-24">
                  <div className="order-2 lg:order-1 relative">
                      <div className="relative rounded-[2rem] md:rounded-[2.5rem] overflow-hidden shadow-2xl shadow-stone-200 border-4 border-white h-[300px] md:h-auto">
                      ...
                      <div className="absolute -bottom-6 -right-4 md:-bottom-8 md:-right-8 bg-white p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] shadow-xl border border-stone-50 max-w-[200px] md:max-w-xs hidden sm:block">
                          <div className="flex items-center gap-3 mb-2">
                             <div className="p-2 bg-amber-50 rounded-xl text-cobalt">
                          ...
                          <p className="text-[10px] md:text-xs text-stone-500 leading-relaxed">We control the entire value chain from design to fabrication, ensuring zero compromise on quality.</p>
                      </div>
                  </div>

                  <div className="order-1 lg:order-2">
                      <div className="inline-flex items-center gap-2 mb-4 md:mb-6 px-3 py-1.5 md:px-4 md:py-2 bg-amber-50 rounded-full border border-amber-100">
                          <Factory className="text-cobalt w-3 h-3 md:w-4 md:h-4" />
                          <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-cobalt">Manufacturer, Not Just Supplier</span>
                      </div>
                      <h2 className="font-display text-4xl md:text-6xl font-bold text-ink mb-4 md:mb-6 leading-tight">
                          Total Control Over <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-cobalt to-stone-800">Every Detail.</span>
                      </h2>
                      <p className="text-base md:text-lg text-stone-600 leading-relaxed mb-6 md:mb-8">
           ...
           <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
              <SectionReveal>
                <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-white border border-stone-100 shadow-sm rounded-full mb-6 md:mb-8">
                   ...
                   <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-stone-500">ISO 9001 • 14001 • 45001</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6">
                    <Link href="/contact">
                        <Button size="lg" className="bg-cobalt text-white hover:bg-yellow-600 h-14 md:h-16 px-10 md:px-12 text-sm md:text-base rounded-full shadow-2xl shadow-yellow-500/30 hover:-translate-y-1 transition-all w-full sm:w-auto">
                           Contact Us
                        </Button>
                    </Link>
                    <Link href="/about">
                        <Button variant="outline" size="lg" className="h-14 md:h-16 px-10 md:px-12 text-sm md:text-base rounded-full border-stone-200 bg-white hover:bg-stone-50 text-stone-700 w-full sm:w-auto">
                           Our Locations
                        </Button>
                    </Link>
                </div>
